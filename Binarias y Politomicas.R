...
```{r}
bar_colors <- c("skyblue","antiquewhite","aquamarine",
            "cadetblue")
...
##Ejercicio 3 Binarias------------------------------------------------


---
title: "Binarias COVID"
author: "Alan Uriel Perez Huerta"
date: "16 de septiembre de 2025"
output: html_document
---
...
```{r}
bar_colors <- c("magenta", "lightblue")

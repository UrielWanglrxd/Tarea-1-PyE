...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "red", main = "Ojiva de Estatura",
...
# Gráfico de la ojiva
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "chocolate", main = "Ojiva del Peso Corporal",
...
```{r}
# Datos de nivel de contaminación en julio (Iztapalapa)
...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "skyblue4", main = "Ojiva del Nivel de Contaminación",
...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "red", main = "Ojiva de la Temperatura",
...
---
title: "Continuas Tiempo Traslado"
author: "Alan Uriel Perez Huerta"
date: "2025-09-16"
output: html_document
---
